...
namespace DataAccessLayer
{
    public class ChuyenMucRepository:IChuyenMucRepository
    {
        ...
        public List<ChuyenMucModel> Search(int pageIndex, int pageSize, out long total, string TenChuyenMuc)
        {
            string msgError = "";
            total = 0;
            try
            {
                var dt = _db.ExecuteSProcedureReturnDataTable(out msgError, "User_Chuyenmuc_search",
